...
def update():
    ...
    os.system("cd .. && cd TBB-BOMB && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Mohammad Noyshim                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/noyshim-900 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : lNoylshim             \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
